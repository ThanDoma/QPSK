...
if len(ch2.check_new_1_1)>0:
    if len(ch2.check_new_1_1)==8 and Counter(ch2.B)!=Counter(ch2.check_new_1_1):
        for j in range(4):
            x = ch2.check_new_1_1[i]
            y = ch2.check_new_1_1[i+1]
            ax.plot(x,y,'o', color='r')
    elif len(ch2.check_new_1_1)==32 and Counter(ch2.B)!=Counter(ch2.check_new_1_1): 
...
if len(ch2.check_new_2_2)>0:
    if len(ch2.check_new_2_2)==8 and Counter(ch2.B)!=Counter(ch2.check_new_2_2):
        for j in range(4):
            x = ch2.check_new_2_2[i]
            y = ch2.check_new_2_2[i+1]
            ax.plot(x,y,'o', color='k')
    elif len(ch2.check_new_2_2)==32 and Counter(ch2.B)!=Counter(ch2.check_new_2_2): 
        for i in range(0,32,2):
            x = ch2.check_new_2_2[i]
            y = ch2.check_new_2_2[i+1]
            ax.plot(x,y,'o', color='k')
...
if len(ch2.check_new_3_3)>0:
    if len(ch2.check_new_3_3)==8 and Counter(ch2.B)!=Counter(ch2.check_new_3_3):
        for j in range(4):
            x = ch2.check_new_3_3[i]
            y = ch2.check_new_3_3[i+1]
            ax.plot(x,y,'o', color='c')
    elif len(ch2.check_new_3_3)==32 and Counter(ch2.B)!=Counter(ch2.check_new_3_3): 
        for i in range(0,32,2):
            x = ch2.check_new_3_3[i]
            y = ch2.check_new_3_3[i+1]
            ax.plot(x,y,'o', color='c')
